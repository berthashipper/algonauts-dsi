...
#SBATCH --output=logs/alexnet_feats_%A_%a.out
#SBATCH --error=logs/alexnet_feats_%A_%a.err
...
# Move to script directory and run AlexNet extraction script
cd /net/projects/ycleong/users/dsi_sl_2025/algonauts_tutorial/scripts
python alex_net_visual_extraction.py "$FOLDER"
