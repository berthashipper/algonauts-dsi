...
python prepare_time_encoding_model.py \
    --fmri_root "$FMRI_ROOT" \
    --subject "$SUBJECT" \
    --train_movies "$TRAIN_MOVIES" \
    --val_movies "$VAL_MOVIES" \
    --modality_paths "visual:/net/projects/ycleong/users/dsi_sl_2025/algonauts_tutorial/results/pca9/alexnet_visual,audio:/net/projects/ycleong/users/dsi_sl_2025/algonauts_tutorial/results/pca10/hubert_audio_l19,language:/net/projects/ycleong/users/dsi_sl_2025/algonauts_tutorial/results/pca50/roberta_language_l7_ctx3" \
