# Only the script name and docstrings are changed; functionality is identical
import argparse
import os
import numpy as np
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dirs', nargs='+', required=True,
                        help='List of directories with raw .npy audio features')
    parser.add_argument('--raw_root', required=True,
                        help='Root directory of original .npy audio features')
    parser.add_argument('--save_root', required=True,
                        help='Root directory for saving PCA audio outputs')
